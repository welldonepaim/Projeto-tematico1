    ...
    def salvar(self):
        try:
            ...
            if tipo == "Preventiva" and status == "Programada":
                ...
                # cria a primeira manutenção programada
                ...
                try:
                    ...
                    messagebox.showerror("Erro", f"Planejamento criado, mas falha ao inserir manutenção: {e}")
                    return

                messagebox.showinfo("Sucesso", "Planejamento e primeira manutenção cadastrados com sucesso!")
            else:
